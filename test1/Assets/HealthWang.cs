...
using System;
using System.Text;
public class HealthWang : MonoBehaviour
{
    ...
    public void swCreate(string word,int wposition){
        Transform sw = Instantiate(skillword, new Vector2(wposition,-3), Quaternion.identity);
        SkillWord sword = sw.GetComponent<SkillWord>();
        sword.Setup(word);
    }
